...
|----|-------------|--------|---|---------|---------|
| REQ-UI-001 | Login page (BRD-1, BRD-90, BRD-94, Phase 1) | Not Started | 0% | — | [view](#d-req-ui-001) |
| REQ-UI-002 | Register page (BRD-91, BRD-95, Phase 1) | Not Started | 0% | — | [view](#d-req-ui-002) |
| REQ-UI-003 | Forgot-password page (BRD-92, Phase 1) | Not Started | 0% | — | [view](#d-req-ui-003) |
| REQ-UI-004 | Reset-password page (BRD-92, Phase 1) | Not Started | 0% | — | [view](#d-req-ui-004) |
| REQ-UI-005 | Profile page (BRD-107, BRD-95, Phase 1) | Not Started | 0% | — | [view](#d-req-ui-005) |
| REQ-UI-006 | Collapsible icon sidebar + nav order (BRD-5, BRD-105, Phase 1) | Not Started | 0% | — | [view](#d-req-ui-006) |
| REQ-UI-007 | Header Sync now + last-sync badge (BRD-6, Phase 1) | Not Started | 0% | — | [view](#d-req-ui-007) |
| REQ-UI-008 | Header user menu (BRD-4, BRD-106, Phase 1) | Not Started | 0% | — | [view](#d-req-ui-008) |
| REQ-UI-009 | Dark-first theme toggle, persisted (BRD-85, Phase 1) | Not Started | 0% | — | [view](#d-req-ui-009) |
| REQ-UI-010 | Header Framework switch (BRD-108, Phase 1) | Not Started | 0% | — | [view](#d-req-ui-010) |
| REQ-UI-011 | Repos page — grid, KPIs, empty state (BRD-98, Phase 1) | Not Started | 0% | — | [view](#d-req-ui-011) |
| REQ-UI-012 | Connect-repo dialog with Validate (BRD-99, BRD-100, Phase 1) | Not Started | 0% | — | [view](#d-req-ui-012) |
| REQ-UI-013 | Remove-repo confirm dialog (BRD-101, Phase 1) | Not Started | 0% | — | [view](#d-req-ui-013) |
| REQ-UI-014 | Coverage page — badge, KPIs, repo cards, stream table (BRD-39, BRD-40, BRD-43, BRD-44, Phase 2) | Not Started | 0% | — | [view](#d-req-ui-014) |
| REQ-UI-015 | Coverage staleness warning in words (BRD-41, Phase 2) | Not Started | 0% | — | [view](#d-req-ui-015) |
| REQ-UI-016 | Coverage unknown-fields + `v > 1` panel (BRD-42, Phase 2) | Not Started | 0% | — | [view](#d-req-ui-016) |
| REQ-UI-017 | Coverage guarded Rebuild-from-raw button (BRD-21, Phase 2) | Not Started | 0% | — | [view](#d-req-ui-017) |
| REQ-UI-018 | Three questions — per-type tabs, no total, standing note (BRD-45, BRD-50, Phase 2) | Not Started | 0% | — | [view](#d-req-ui-018) |
| REQ-UI-019 | Three questions — labelled backfilled column (BRD-46, Phase 2) | Not Started | 0% | — | [view](#d-req-ui-019) |
| REQ-UI-020 | Gate catch distribution table (BRD-47, Phase 2) | Not Started | 0% | — | [view](#d-req-ui-020) |
| REQ-UI-021 | Tainted-REQ list (BRD-48, Phase 2) | Not Started | 0% | — | [view](#d-req-ui-021) |
| REQ-UI-022 | Late-gate coverage lines (BRD-49, Phase 2) | Not Started | 0% | — | [view](#d-req-ui-022) |
| REQ-UI-023 | Harness page — three harness columns (BRD-51, Phase 2) | Not Started | 0% | — | [view](#d-req-ui-023) |
| REQ-UI-024 | Tokens per verified REQ per harness (BRD-52, Phase 2) | Not Started | 0% | — | [view](#d-req-ui-024) |
| REQ-UI-025 | OpenCode-only dollars card, no cross-harness total (BRD-53, BRD-54, Phase 2) | Not Started | 0% | — | [view](#d-req-ui-025) |
| REQ-UI-026 | `harness: null` footnote row (BRD-55, Phase 2) | Not Started | 0% | — | [view](#d-req-ui-026) |
| REQ-UI-027 | Routing drift tab + table (BRD-56, Phase 2) | Not Started | 0% | — | [view](#d-req-ui-027) |
| REQ-UI-028 | Tokens by observed model (BRD-57, Phase 2) | Not Started | 0% | — | [view](#d-req-ui-028) |
| REQ-UI-029 | Counterfactual repricing cards, labelled estimate (BRD-58, BRD-59, BRD-60, Phase 2) | Not Started | 0% | — | [view](#d-req-ui-029) |
| REQ-UI-030 | Edit-prices dialog (BRD-61, Phase 2) | Not Started | 0% | — | [view](#d-req-ui-030) |
| REQ-UI-031 | Poolable-metrics cards (BRD-62, Phase 2) | Not Started | 0% | — | [view](#d-req-ui-031) |
| REQ-UI-032 | Export page — button, dataset SHAs, past snapshots (BRD-63, BRD-70, Phase 2) | Not Started | 0% | — | [view](#d-req-ui-032) |
| REQ-UI-033 | Quotable banner + last-parity card (BRD-67, BRD-71, Phase 2) | Not Started | 0% | — | [view](#d-req-ui-033) |
| REQ-UI-034 | Playbook state of the five report pages (BRD-75, BRD-108, BRD-110, Phase 3) | Not Started | 0% | — | [view](#d-req-ui-034) |
| REQ-FN-001 | AppManagerClient — public-key cache, RSA-OAEP-256, login (BRD-90, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-001) |
| REQ-FN-002 | Registration with `applicationRoleCode: "Manager"` (BRD-91, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-002) |
| REQ-FN-003 | Forgot / reset password via AppManager (BRD-92, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-003) |
| REQ-FN-004 | Session — own cookie, server-side tokens, refresh/validate/logout (BRD-93, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-004) |
| REQ-FN-005 | Cookie auth gate on every non-anonymous page (BRD-2, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-005) |
| REQ-FN-006 | Sign-in redirect and landing rules (BRD-1, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-006) |
| REQ-FN-007 | Sign out — AppManager logout + cookie clear (BRD-4, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-007) |
| REQ-FN-008 | Manager-only; never call LicenseSvc/FeatureSvc/PaymentSvc/IssueSvc (BRD-95, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-008) |
| REQ-FN-009 | Demo user `TfLensDemo` (BRD-96, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-009) |
| REQ-FN-010 | AppManager connection from configuration only (BRD-97, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-010) |
| REQ-FN-011 | Profile read + change password via UserSvc (BRD-107, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-011) |
...
| REQ-FN-013 | Per-user repo list read with counts (BRD-98, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-013) |
| REQ-FN-014 | Connect validation — exists, public, telemetry path, kind (BRD-99, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-014) |
| REQ-FN-015 | Refuse private repos; optional PAT raises rate limit only (BRD-100, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-015) |
| REQ-FN-016 | Remove repo = stop sync + purge rows and raw (BRD-101, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-016) |
| REQ-FN-017 | `UserId` scoping on every read, write, cache and path (BRD-102, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-017) |
| REQ-FN-018 | Poller syncs all users; Sync now syncs only the caller's repos (BRD-103, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-018) |
| REQ-FN-019 | Duplicate `owner/name` rejected per user, allowed across users (BRD-104, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-019) |
| REQ-FN-020 | `BackgroundService` poll on the configured interval (BRD-12, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-020) |
| REQ-FN-021 | Latest-SHA lookup and skip-when-unchanged (BRD-13, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-021) |
| REQ-FN-022 | Whole-file fetch at the exact SHA; 404 = stream absent (BRD-14, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-022) |
| REQ-FN-023 | Per-repo error isolation with redacted `LastError` (BRD-15, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-023) |
| REQ-FN-024 | Structurally read-only against GitHub — GET only (BRD-16, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-024) |
| REQ-FN-025 | `sync_state` update per user and repo (BRD-17, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-025) |
| REQ-FN-026 | Analysis cache invalidation after sync or rebuild (BRD-18, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-026) |
| REQ-FN-027 | Raw archive written verbatim before parsing (BRD-19, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-027) |
| REQ-FN-028 | `rebuild` command verb (BRD-20, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-028) |
| REQ-FN-029 | Rebuild report and count-identity with live sync (BRD-22, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-029) |
| REQ-FN-030 | Stream tables + `SyncState` with SCHEMA.md-exact columns (BRD-23, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-030) |
| REQ-FN-031 | JSON `Overflow` column for unknown fields and `v > 1` (BRD-24, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-031) |
| REQ-FN-032 | Count and skip invalid JSON lines (BRD-25, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-032) |
| REQ-FN-033 | Dedupe `commits` on `sha` per repo (BRD-26, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-033) |
| REQ-FN-034 | Dedupe `sessions` — highest `output_tokens`, tie latest `ts` (BRD-27, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-034) |
| REQ-FN-035 | Dedupe `runs` and `gates` on their natural keys (BRD-28, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-035) |
| REQ-FN-036 | Preserve provenance fields verbatim; absent optionals `NULL` (BRD-29, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-036) |
| REQ-FN-037 | Secrets only from the PascalCase env-var provider (BRD-8, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-037) |
| REQ-FN-038 | Refuse to start on missing secret or unreachable DB (BRD-9, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-038) |
| REQ-FN-039 | `DataRoot` override (BRD-11, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-039) |
| REQ-FN-040 | One multi-stage Docker image with `data/` + `logs/` volumes (BRD-77, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-040) |
| REQ-FN-041 | `/healthz` anonymous endpoint (BRD-78, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-041) |
| REQ-FN-042 | README with the out-of-scope list verbatim (BRD-79, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-042) |
| REQ-FN-043 | `DECISIONS.md` (BRD-80, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-043) |
| REQ-FN-044 | `sync` command verb (BRD-81, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-044) |
| REQ-FN-045 | `docker compose` with PostgreSQL 16 + idempotent schema script (BRD-111, Phase 1) | Not Started | 0% | — | [view](#d-req-fn-045) |
| REQ-FN-046 | Figures computed at request time; nothing derived written back (BRD-30, Phase 2) | Not Started | 0% | — | [view](#d-req-fn-046) |
| REQ-FN-047 | Live and backfilled never pool (BRD-31, Phase 2) | Not Started | 0% | — | [view](#d-req-fn-047) |
| REQ-FN-048 | Never pool across `project_type`; inferred → `unclassified` (BRD-32, Phase 2) | Not Started | 0% | — | [view](#d-req-fn-048) |
| REQ-FN-049 | Backfill-taint exclusion and excluded-REQ list (BRD-33, Phase 2) | Not Started | 0% | — | [view](#d-req-fn-049) |
| REQ-FN-050 | `Figure` type with `InsufficientData(n)` below min n = 3 (BRD-34, Phase 2) | Not Started | 0% | — | [view](#d-req-fn-050) |
| REQ-FN-051 | `Pooled.CostUsd` always null (BRD-35, Phase 2) | Not Started | 0% | — | [view](#d-req-fn-051) |
| REQ-FN-052 | Late-added gates reported as `ran` beside `caught` (BRD-36, Phase 2) | Not Started | 0% | — | [view](#d-req-fn-052) |
| REQ-FN-053 | Poolable metrics with the reference's formulas and rounding (BRD-37, Phase 2) | Not Started | 0% | — | [view](#d-req-fn-053) |
| REQ-FN-054 | Fixture-driven engine parity unit test (BRD-38, Phase 2) | Not Started | 0% | — | [view](#d-req-fn-054) |
| REQ-FN-055 | Framework as a stored provenance axis, never pooled (BRD-108, Phase 2) | Not Started | 0% | — | [view](#d-req-fn-055) |
| REQ-FN-056 | Snapshot writer — `snapshot.md` + `tflens.json` per user and date (BRD-63, Phase 2) | Not Started | 0% | — | [view](#d-req-fn-056) |
| REQ-FN-057 | `export` command verb (BRD-64, Phase 2) | Not Started | 0% | — | [view](#d-req-fn-057) |
| REQ-FN-058 | `tflens.json` key layout matches `--rollup --json` + extras/parity (BRD-65, Phase 2) | Not Started | 0% | — | [view](#d-req-fn-058) |
| REQ-FN-059 | Export never mixes provenances; every estimate labelled (BRD-66, Phase 2) | Not Started | 0% | — | [view](#d-req-fn-059) |
| REQ-FN-060 | Parser version stamped into build and every export (BRD-68, Phase 2) | Not Started | 0% | — | [view](#d-req-fn-060) |
| REQ-FN-061 | `tools/parity-compare.py` key-by-key diff (BRD-69, Phase 2) | Not Started | 0% | — | [view](#d-req-fn-061) |
| REQ-FN-062 | Dataset SHAs readable from export and Coverage (BRD-70, Phase 2) | Not Started | 0% | — | [view](#d-req-fn-062) |
| REQ-FN-063 | `data/parity-last.json` + DECISIONS.md record of each pass (BRD-71, Phase 2) | Not Started | 0% | — | [view](#d-req-fn-063) |
| REQ-FN-064 | Hand spot-check of the no-oracle extras, recorded (BRD-72, Phase 2) | Not Started | 0% | — | [view](#d-req-fn-064) |
| REQ-FN-065 | `events.ndjson` fetch, archive and `PbEvent` tables (BRD-73, Phase 3) | Not Started | 0% | — | [view](#d-req-fn-065) |
| REQ-FN-066 | `phase_gate` never shares a table, column or chart with `gate` (BRD-74, Phase 3) | Not Started | 0% | — | [view](#d-req-fn-066) |
| REQ-FN-067 | Playbook-native report data — phase totals, parentID split (BRD-75, Phase 3) | Not Started | 0% | — | [view](#d-req-fn-067) |
| REQ-FN-068 | Schema discovery recorded in DECISIONS.md before columns are fixed (BRD-76, Phase 3) | Not Started | 0% | — | [view](#d-req-fn-068) |
| REQ-FN-069 | Schema-v1 Playbook repos reuse parser, engine and pages (BRD-109, Phase 3) | Not Started | 0% | — | [view](#d-req-fn-069) |
| REQ-FN-070 | Full Playbook report set incl. snapshot export (BRD-110, Phase 3) | Not Started | 0% | — | [view](#d-req-fn-070) |
| REQ-NFR-001 | Report-page and sync performance (BRD-82, Phase 2) | Not Started | 0% | — | [view](#d-req-nfr-001) |
| REQ-NFR-002 | Security posture — cookies, antiforgery, PAT scope, forwarded headers (BRD-83, Phase 1) | Not Started | 0% | — | [view](#d-req-nfr-002) |
| REQ-NFR-003 | Secrets and tokens never logged, displayed or exported (BRD-10, Phase 1) | Not Started | 0% | — | [view](#d-req-nfr-003) |
| REQ-NFR-004 | Privacy — only stream-carried data stored and shown (BRD-84, Phase 2) | Not Started | 0% | — | [view](#d-req-nfr-004) |
| REQ-NFR-005 | Accessibility and theme (BRD-85, Phase 1) | Not Started | 0% | — | [view](#d-req-nfr-005) |
| REQ-NFR-006 | Observability — Serilog rolling file + console (BRD-86, Phase 1) | Not Started | 0% | — | [view](#d-req-nfr-006) |
| REQ-NFR-007 | Reliability — failure containment and rebuildability (BRD-87, Phase 1) | Not Started | 0% | — | [view](#d-req-nfr-007) |
| REQ-NFR-008 | Testability — web-free Core, fixtures, `data-testid` (BRD-88, Phase 1) | Not Started | 0% | — | [view](#d-req-nfr-008) |
| REQ-NFR-009 | Integrity — no switch relaxes the provenance rules (BRD-89, Phase 2) | Not Started | 0% | — | [view](#d-req-nfr-009) |
| REQ-NFR-010 | Cross-user isolation proven by a two-user integration test (BRD-102, BRD-83, Phase 1) | Not Started | 0% | — | [view](#d-req-nfr-010) |
